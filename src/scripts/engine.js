...
async function updateScore() {
    let { playerScore, computerScore, scoreBox } = state.score;
    scoreBox.innerText = `Player:${playerScore} | Computer:${computerScore}`;
}
...
function init() {
    ...
    drawCards(6, playerSides.player1);
    drawCards(6, playerSides.computer);
